...
SCALES = ('hour', 'semiday', 'day', 'week', 'month', 'quarter', 'half', 'year')
RESOLUTIONS = {'hour': '-1hours', 'semiday': '-13hours', 'day': '-26hours', 'week':'-8d', 'month':'-35d', 'quarter':'-90d',
